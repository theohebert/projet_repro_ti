...
y, X = dmatrices('redCards ~ rating + rating*positionGroup + rating*weight', data=df, return_type='dataframe')
...
results += "\n" + test_question(y, X, exposure_array,results)

ecriture_fichier("./results.txt", results)
